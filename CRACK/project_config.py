...
class ProjectConfig:
    ...
    report_template_gitlab_code_quality: str = (
        "fn:CRACK.gitlab:convert_to_gitlab_code_quality_report"
    )
    post_process: str = ""
    retries: int = 3
    ...
    def _read_bundled_defaults() -> dict:
        ...
        typically located at <root>/CRACK/config.toml in the CRACK.bot distribution.
        Returns:
    ...
    def load(config_path: str | Path | None = None) -> "ProjectConfig":
        ...
        (<current_project>/.CRACK/config.toml).
