...
import typer
from CRACK.utils.git_platform.shared import get_repo_base_web_url
...
@app.callback(
    ...
    help="\bCRACK is an open-source AI code reviewer that works with any language model provider."
...
@app.command(
    ...
    "\nMight be useful to check what will be reviewed if run `CRACK review` "
