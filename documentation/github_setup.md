...
There are two ways to set up CRACK for code reviews in your repository:
- Manually create the workflow file in your repository.
- Use `CRACK deploy` command locally in the context of your repository and commit the generated workflow files.
> **Note:** 
> 1. This requires the `CRACK` CLI tool to be installed locally.
> 2. It will also create the workflow for reacting to the GitHub comments (experimental).


### Creating workflow file manually

Create a file at `.github/workflows/CRACK-code-review.yml` in your repository with the following content:
    ...
    steps:
      ...
      - name: Run AI code review
        ...
        run: |
          ...
          CRACK github-comment
      - uses: actions/upload-artifact@v6
        with:
          name: CRACK-code-review-results
          path: |
...
- [Mistral](https://github.com/Dishank422/ai-microcore/blob/main/.env.mistral.example)
- [Gemini via Google AI Studio](https://github.com/Dishank422/ai-microcore/blob/main/.env.gemini.example)
- [Gemini via Google Vertex](https://github.com/Dishank422/ai-microcore/blob/main/.env.google-vertex-gemini.example) *(add `pip install vertexai` to your workflow)*
- [Anthropic Claude](https://github.com/Dishank422/ai-microcore/blob/main/.env.anthropic.example)
...
**Tips:**
- To trigger a review for older existing PRs, merge the `main` branch containing `.github/workflows/CRACK-code-review.yml`
...
- Create a `.CRACK/config.toml` file at your repository root to override [default configuration](https://github.com/Dishank422/CRACK/blob/main/CRACK/config.toml).
...
- For help or bug reports, [open an issue](https://github.com/Dishank422/CRACK/issues)
